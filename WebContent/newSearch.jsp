...
<html>
    <head>
        ...
        <script type="text/javascript">
        	  ...
        	  calender('#inp1').init(function(date){
        	 		this.value = date
        	 		var i = date;
           		 var t1 = (i.substring(0,4));
       	         var t2 = (i.substring(5,7));
       	         var t3 = (i.substring(8,10));
       	         var time = t3+"/"+t2+"/"+t1;
        	  ...
        	  calender('#inp2').init(function(date){
      	 		this.value = date
      	 		var i = date;
         		 var t1 = (i.substring(0,4));
     	         var t2 = (i.substring(5,7));
...
//                $(".clearBtn").text(languages['Reset']);
           ...
           function changePy(){
            	var a = $("#pn").val();
            	var i = ConvertPinyin(a).toUpperCase();
...
<!--                     <td style="width:50px;"> -->
                   ...
                   <!-- <td>
                    ...
                    <td>
                        ...
                        <input type="search" class="fsdate" id="begin"/>
                        <input type="text" id="inp1" placeholder="选择日期"> 
                    ...
                    <td>
                        ...
                        <input type="search" class="tsdate"   id="end"/>
                ...
                <tr>   
                    ...
                    <td colspan="2">   
                    	<button id="okBtn" onclick="searchClick(this)" style="float: left;width:7em;height:27px; font-size: 14px; margin-right: 10px;" class="searchBtn">Search</button>                                            	
    	                	<button id="resetBtn" onclick="window.location.reload('defalt.jsp');" style="float: left;width:7em; height:27px; font-size: 14px;" class="clearBtn">Reset</button>           	                    	
	                	</td>
                </tr>
            </table>
        </div>
